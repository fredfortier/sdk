...
exports.contractWrappersErrorToHumanReadableError = (_a = {},
    ...
    _a[ContractWrappersError.InsufficientAllowanceForTransfer] = 'Insufficient allowance for transfer',
    _a[ContractWrappersError.InsufficientBalanceForTransfer] = 'Insufficient balance for transfer',
    _a[ContractWrappersError.InsufficientEthBalanceForDeposit] = 'Insufficient ETH balance for deposit',
    _a[ContractWrappersError.InsufficientWEthBalanceForWithdrawal] = 'Insufficient WETH balance for withdrawal',
    ...
    _a[ContractWrappersError.SubscriptionNotFound] = 'Subscription not found',
    _a[ContractWrappersError.SubscriptionAlreadyPresent] = 'Subscription already present',
    _a[OrderError.InvalidSignature] = 'Order signature is not valid',
    _a[BlockchainCallErrs.ContractDoesNotExist] = 'Contract does not exist',
    _a[BlockchainCallErrs.UserHasNoAssociatedAddresses] = 'User has no addresses available',
    _a[BlockchainCallErrs.UnhandledError] = 'Unhandled Error',
    _a[BlockchainCallErrs.TokenAddressIsInvalid] = 'Token address is invalid',
    _a);
...
exports.exchangeContractErrorToHumanReadableError = (_b = {},
    ...
    _b[ExchangeContractErrs.MultipleMakersInSingleCancelBatchDisallowed] = 'Multiple makes in a single cancel batch are disallowed',
    _b[ExchangeContractErrs.InsufficientRemainingFillAmount] = 'Insufficient remaining fill amount',
    _b[ExchangeContractErrs.MultipleTakerTokensInFillUpToDisallowed] = 'Multiple taker tokens in a fill up to call are disallowed',
    _b[ExchangeContractErrs.BatchOrdersMustHaveSameExchangeAddress] = 'Batch orders must have the same exchange address',
    _b[ExchangeContractErrs.BatchOrdersMustHaveAtLeastOneItem] = 'Batch orders cannot by empty',
    _b);
