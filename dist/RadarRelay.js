...
var MarketsCache_1 = require("./pagination/MarketsCache");
...
var RadarRelay = /** @class */ (function () {
    ...
    function RadarRelay(wallet, walletType, config) {
        ...
        this.loadPriorityList = [
            { event: types_1.EventName.EthereumInitialized, func: this.initEthereumNetworkIdAsync },
            { event: types_1.EventName.EthereumNetworkIdInitialized, func: this.initZeroEx },
            { event: types_1.EventName.ZeroExInitialized, func: this.initTokensAsync },
            { event: types_1.EventName.TokensInitialized, func: this.initAccountAsync, args: [0] },
            { event: types_1.EventName.AccountInitialized, func: this.initTrade },
            { event: types_1.EventName.TradeInitialized, func: this.initMarketsAsync },
            { event: types_1.EventName.MarketsInitialized, func: undefined }
        ];
        this._wallet = wallet;
    ...
    RadarRelay.prototype.initTrade = function () {
        this._trade = new Trade_1.Trade(this.zeroEx, this._config.radarRestEndpoint, this.account, this.events);
        return this.getCallback(types_1.EventName.TradeInitialized, this._trade);
    };
    RadarRelay.prototype.initTokensAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response, tokens, entries;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(!this.tokens || !this.tokens.size)) return [3 /*break*/, 2];
                        return [4 /*yield*/, axios_1.default.get(this._config.radarRestEndpoint + "/tokens")];
                    case 1:
                        response = _a.sent();
                        tokens = response.data;
                        entries = tokens.map(function (token) { return [token.address, token]; });
                        this.tokens = new Map(entries);
                        tokens.map(function (token) { return _this.tokens.set(token.address, token); });
                        _a.label = 2;
                    case 2: 
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.markets = new MarketsCache_1.MarketsCache(1, // Starting page... TODO: make this configurable at the SDK-level
                        100, // Results per page... TODO: make this configurable at the SDK-level
                        this._config.radarRestEndpoint, this._config.radarWebsocketEndpoint, this._config.radarRestEndpoint + "/markets", this._trade);
                        return [4 /*yield*/, this.markets.getAsync('ZRX-WETH')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.markets.getNextPageAsync()];
                    case 2:
                        _a.sent();
